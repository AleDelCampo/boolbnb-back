            ...
            <div id="lateral-nav" class="row p-5">
                <div class="col 12">
                    ...
                    <div id="nav-list" class="row mt-5">
                        ...
                        <div class="col-12 py-2">
                            <a class="btn my_bg_color fw-bold w-100" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">{{ __('Logout') }}</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex justify-content-end align-items-center">
                                        <div class="d-flex flex-column gap-2">
                                            <a class="btn my_btn" href="{{ route('admin.apartments.show', $apartment) }}">Visualizza</a>
                                            <a class="btn my_btn" href="{{ route('admin.sponsor.create', $apartment->slug) }}">Crea Sponsorizzazione</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>
