    ...
    <div class="container py-4">
        ...
        <form action="{{route('admin.apartments.update', $apartment)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-2">
                ...
                <input type="number" class="form-control @error('n_rooms') is-invalid @enderror" id="n_rooms" value="{{ old('n_rooms') ?? $apartment->n_rooms }}" name="n_rooms" min="0">
                @error('n_rooms')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
            ...
            <div class="mb-2">
                ...
                <input type="number" class="form-control @error('n_beds') is-invalid @enderror" id="n_beds" value="{{ old('n_beds') ?? $apartment->n_beds }}" name="n_beds" min="0">
                @error('n_beds')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
            ...
            <div class="mb-2">
                ...
                <input type="number" class="form-control @error('n_bathrooms') is-invalid @enderror" id="n_bathrooms" value="{{ old('n_bathrooms') ?? $apartment->n_bathrooms }}" name="n_bathrooms" min="0">
                @error('n_bathrooms')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
            ...
            <div class="mb-2">
                ...
                <input type="number" class="form-control @error('squared_meters') is-invalid @enderror" id="squared_meters" value="{{ old('squared_meters') ?? $apartment->squared_meters }}" name="squared_meters" min="0">
